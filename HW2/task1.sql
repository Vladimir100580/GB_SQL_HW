...
SELECT TIMESTAMPDIFF(MONTH,'2002-05-18','2006-08-29') > 10;
UPDATE profiles
SET is_active = 0
WHERE (TIMESTAMPDIFF(MONTH,'2002-05-18','2006-08-29') > 3);

-- WHERE (birthday + INTERVAL 18 YEAR) > NOW();
-- SELECT DATEDIFF(year, birthday, NOW());
